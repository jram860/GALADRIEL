...
G4VPhysicalVolume* DetectorConstruction::ConstructCalorimeter()
{
    ...
    {
        // Filter
        G4Box* solidFilter = new G4Box("Filter", 0.5*sizeXY, 0.5*sizeXY, filterThicknesses[i]/2);
        ...
        // Detector
        G4Box* solidDetector = new G4Box("Detector", 0.5*sizeXY, 0.5*sizeXY, detectorThicknesses[i]/2);
