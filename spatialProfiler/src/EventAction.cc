...
void EventAction::AddEnergyDeposition(size_t detectorIndex, G4double edep)
{
...
void EventAction::AddEnergyProfile(size_t detectorIndex, G4double xpos,G4double edep)
{
